...
Readability.prototype = {
  ...
  REGEXPS: {
    ...
    okMaybeItsACandidate:
      /and|article|body|column|content|main|mathjax|shadow|hljs-|katex-|mp-common-videosnap|preserve-class-tag/i,
    ...
    normalize: /\s{2,}/g,
    videos:
      /\/\/(www\.)?((dailymotion|youtube|youtube-nocookie|player\.vimeo|mpvideo|qpic|v\.qq|bilibili|live.bilibili)\.com|(archive|upload\.wikimedia)\.org|player\.twitch\.tv)|.cn/i,
